...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  ...
  include("/mnt/storage/helena/brain/native/swarm_brain_tactician/target/release/build/llama-cpp-sys-2-d14cf5e22e20ac03/out/build/ggml/src/cmake_install.cmake")
endif()

if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib64" TYPE STATIC_LIBRARY FILES "/mnt/storage/helena/brain/native/swarm_brain_tactician/target/release/build/llama-cpp-sys-2-d14cf5e22e20ac03/out/build/ggml/src/libggml.a")
endif()
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib64" TYPE STATIC_LIBRARY FILES "/mnt/storage/helena/brain/native/swarm_brain_tactician/target/release/build/llama-cpp-sys-2-d14cf5e22e20ac03/out/build/ggml/src/libggml-base.a")
endif()

if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib64/cmake/ggml" TYPE FILE FILES
    "/mnt/storage/helena/brain/native/swarm_brain_tactician/target/release/build/llama-cpp-sys-2-d14cf5e22e20ac03/out/build/ggml/ggml-config.cmake"
    "/mnt/storage/helena/brain/native/swarm_brain_tactician/target/release/build/llama-cpp-sys-2-d14cf5e22e20ac03/out/build/ggml/ggml-version.cmake"
    )
endif()
...
if(CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "/mnt/storage/helena/brain/native/swarm_brain_tactician/target/release/build/llama-cpp-sys-2-d14cf5e22e20ac03/out/build/ggml/install_local_manifest.txt"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
